...
CREATE TABLE IF NOT EXISTS `betsbettingspree`.`team_stats` (
  ...
  `avgGoalsForHome` INT NOT NULL,
  `avgGoalsForAway` INT NOT NULL,
  `avgGoalsAgainstHome` INT NOT NULL,
  `avgGoalsAgainstAway` INT NOT NULL,
  `avgGoalsForTotal` INT NOT NULL,
  `avgGoalsAgainstTotal` INT NOT NULL,
